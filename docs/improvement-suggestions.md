...
- Add data-test-id attributes for stable automation on listing cards and filter controls (e.g., data-test="listing-card", data-test="filter-min-price") — greatly improves test stability and reduces flakiness.
